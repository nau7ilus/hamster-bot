...
module.exports = class Command {
  ...
  constructor(props, runFunction) {
    ...
    if (props.clientPermissions)
      this.clientPermissions =
        props.clientPermissions.length > 0 ? props.clientPermissions : ["SEND_MESSAGES"];
    if (props.userPermissions)
      this.userPermissions =
        props.userPermissions.length > 0 ? props.userPermissions : ["SEND_MESSAGES"];
