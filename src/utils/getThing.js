...
module.exports = async (client, dataType, text) => {
  ...
  switch (dataType) {
    case "command":
      return (
        client.commands.find((c) => c.name == text || (c.aliases && c.aliases.includes(text))) ||
        false
      );
    case "channel":
      return (
        message.guild.cache.channels.get(text) ||
    ...
    case "guild":
      return (
        ...
        client.guilds.cache.find(
          (g) => g.name.toLowerCase().includes(text.toLowerCase()) && text.length > 1
        ) ||
        false
      );
    case "member":
      return (
        ...
        message.guild.cache.members.find(
          (m) =>
    ...
    case "role":
      return (
        ...
        message.guild.roles.cache.find(
          (r) => r.name.toLowerCase().includes(text.toLowerCase()) && text.length > 1
        ) ||
        false
      );
    case "emote":
      return (
        ...
        client.emojis.cache.find(
          (e) => e.name.toLowerCase().includes(text.toLowerCase()) && text.length > 1
        ) ||
        false
      );
    case "message":
